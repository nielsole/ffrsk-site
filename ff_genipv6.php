...
root@dns:/srv/www/vhosts/netsecdb.de/httpdocs/freifunk# more ff_genipv6.php
<?php
// generate IPv6 from nodeid
// (c) 2017-2020 by Claus Marxmeier
$debug="";
...
// Voreifel
$ipv6_voreifel_prefix_01="      2a03:2260:301a:1000:";
$ipv6_voreifel_prefix_02="      2a03:2260:301a:2000:";
...
echo $platform;
echo $platform;
echo "Supernodes Voreifel:".$platform.$platform;
echo "Rheinbach : ".$ipv6_voreifel_prefix_01.$ipv6.$platform;
echo "Meckenheim: ".$ipv6_voreifel_prefix_02.$ipv6.$platform;
